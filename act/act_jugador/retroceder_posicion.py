...
class Retroceder_Posicion:
    def __init__(self, agente) -> None:
        ...
        self.tipo = config.ACT_RETROCEDER_POSICION
        self.tiempo = 0
    ...
    def precondicion(self, partido) -> bool:
        return  self.agente.ubicacion_campo != config.IA.Zona.DEFENSA
    ...
    def poscondicion(self, partido):
        self.agente.ubicacion_campo = config.IA.Zona.ANTERIOR_ZONA[self.agente.ubicacion_campo]
