...
def main():
    ...
    t1_name = ['messi', 'fati', 'depay', 'de jong', 'neymar', 'iniesta', 'gavi', 'pedri', 'dembele', 'dani alves', 'eric garcia', 'ter stegen']
    t1_pos = [config.POSICIONES.POS[0], config.POSICIONES.POS[0], config.POSICIONES.POS[0], config.POSICIONES.POS[1], config.POSICIONES.POS[2], config.POSICIONES.POS[0], config.POSICIONES.POS[1], config.POSICIONES.POS[1], config.POSICIONES.POS[2], config.POSICIONES.POS[2], config.POSICIONES.POS[2], config.POSICIONES.POS[3]]
    ...
    t2_pos = [config.POSICIONES.POS[0], config.POSICIONES.POS[0], config.POSICIONES.POS[2], config.POSICIONES.POS[1], config.POSICIONES.POS[2], config.POSICIONES.POS[0], config.POSICIONES.POS[2], config.POSICIONES.POS[2], config.POSICIONES.POS[1], config.POSICIONES.POS[1], config.POSICIONES.POS[1], config.POSICIONES.POS[3]]
